...
import { CreateMaquinaria } from "../../services/maquinarias";

const New_Maquinaria = ({ nombre }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await CreateMaquinaria(producto);
      ...
      >
        <Modal.Header className="bg-secondary border-bottom-0">
          <Modal.Title className="text-warning">
            <h1 className="fw-bolder">Registrar</h1>
                  ...
                  ([key, value], index) => (
                    <div key={index} className="d-flex mb-2">
                      ...
                      <Form.Control
                        ...
                        value={value}
                        onChange={(e) =>
                          handleDetalleChange(key, e.target.value)
                        }
                      />
                      <Button
                        variant="danger"
